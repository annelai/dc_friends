...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=64 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=64 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=64 WIDTHDIST=6 aclr clk_en clock data distance result
...
module  convert1_altbarrel_shift_30g
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //convert1_altbarrel_shift_30g
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert1_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //convert1_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert1_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
...
endmodule //convert1_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert1_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
...
endmodule //convert1_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert1_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	convert1_altpriority_encoder_be8   altpriority_encoder13
	( 
	.data(data[7:0]),
...
endmodule //convert1_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert1_altpriority_encoder_qf8
	( 
	data,
	q,
	zero) ;
	...
	convert1_altpriority_encoder_rf8   altpriority_encoder11
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	convert1_altpriority_encoder_rf8   altpriority_encoder12
	( 
	.data(data[31:16]),
...
endmodule //convert1_altpriority_encoder_qf8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert1_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //convert1_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert1_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	convert1_altpriority_encoder_3v7   altpriority_encoder25
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder25_q));
	convert1_altpriority_encoder_3e8   altpriority_encoder26
	( 
	.data(data[3:2]),
...
endmodule //convert1_altpriority_encoder_6v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert1_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	convert1_altpriority_encoder_6v7   altpriority_encoder23
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder23_q));
	convert1_altpriority_encoder_6e8   altpriority_encoder24
	( 
	.data(data[7:4]),
...
endmodule //convert1_altpriority_encoder_bv7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert1_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	convert1_altpriority_encoder_bv7   altpriority_encoder21
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder21_q));
	convert1_altpriority_encoder_be8   altpriority_encoder22
	( 
	.data(data[15:8]),
...
endmodule //convert1_altpriority_encoder_r08

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert1_altpriority_encoder_q08
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	convert1_altpriority_encoder_r08   altpriority_encoder19
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder19_q));
	convert1_altpriority_encoder_rf8   altpriority_encoder20
	( 
	.data(data[31:16]),
...
endmodule //convert1_altpriority_encoder_q08

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert1_altpriority_encoder_0c6
	( 
	data,
	q) ;
	input   [63:0]  data;
	...
	convert1_altpriority_encoder_qf8   altpriority_encoder10
	( 
	.data(data[63:32]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	convert1_altpriority_encoder_q08   altpriority_encoder9
	( 
	.data(data[31:0]),
...
endmodule //convert1_altpriority_encoder_0c6

//synthesis_resources = lpm_add_sub 5 lpm_compare 1 reg 377 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert1_altfp_convert_v1n
	( 
	clock,
	dataa,
	result) ;
	...
	convert1_altbarrel_shift_30g   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	convert1_altpriority_encoder_0c6   altpriority_encoder2
	( 
	.data(prio_mag_int_a),
...
endmodule //convert1_altfp_convert_v1n
//VALID FILE
...
module convert1 (
	...
	convert1_altfp_convert_v1n	convert1_altfp_convert_v1n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
