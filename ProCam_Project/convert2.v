...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=64 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=64 clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=86 WIDTHDIST=7 aclr clk_en clock data distance result
...
module  convert2_altbarrel_shift_80g
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //convert2_altbarrel_shift_80g

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 411 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert2_altfp_convert_v1n
	( 
	clock,
	dataa,
	result) ;
	...
	wire  [85:0]   wire_altbarrel_shift6_result;
	...
	convert2_altbarrel_shift_80g   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	assign
		...
		clk_en = 1'b1,
		const_bias_value_add_width_res_w = 8'b10111110,
...
endmodule //convert2_altfp_convert_v1n
//VALID FILE
...
module convert2 (
	...
	convert2_altfp_convert_v1n	convert2_altfp_convert_v1n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
